            ...
            <div class="container clearfix">
                <div class="row gutter-40 col-mb-80">
                    <div class="portlet light row">
                        ...
                        <div class="col-12">
                            <p>
                                At greenpharmacyhall.com, we do our best to ensure that you are completely satisfied with our products. And we are happy to issue a full refund based on the conditions listed below:
                        ...
                        <div class="col-12">
                            ...
                            <p>
                                ...
                                We do our best to ensure that the products you order are delivered according to your specifications. However, should you receive an incomplete order, damaged or incorrect product(s), please notify greenpharmacyhall Customer Support immediately or within 10 working days of receiving the products, to ensure prompt resolution. Please note that greenpharmacyhall.com will not accept liability for such delivery issues if you fail to notify us within 10 working days of receipt.
                                <br>
