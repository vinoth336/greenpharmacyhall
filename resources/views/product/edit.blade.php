                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('is_pharma_product') ? ' has-danger' : '' }}">
                                                <input style="width: 62px;"
                                                       ...
                                                       @if(old('is_pharma_product', $product->is_pharma_product) == 1) checked @endif
                                                       aria-required="true" />
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('is_scheduled_drug') ? ' has-danger' : '' }}">
                                                <input style="width: 62px;"
                                                       ...
                                                       @if(old('is_scheduled_drug', $product->is_scheduled_drug) == 1) checked @endif
                                                       aria-required="true" />
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('is_for_sales') ? ' has-danger' : '' }}">
                                                <input style="width: 62px;"
                                                       ...
                                                       @if(old('is_for_sales', $product->is_for_sales) == 1) checked @endif
                                                       aria-required="true" />
