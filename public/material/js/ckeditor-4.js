...
(function() {
        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
            d = {
                ...
                domReady: function() {
                    ...
                    var b = [];
                    return function(c) {
                        function d() { try { document.documentElement.doScroll("left") } catch (c) { setTimeout(d, 1); return }
                            a() }
                        b.push(c);
                        ...
                        if (1 == b.length)
                            ...
                            c = !1; try { c = !window.frameElement } catch (h) {}
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) { var d = CKEDITOR.event.prototype,
        ...
        return {
            ...
            on: function(b, d, h, k, g) {
                ...
                function v() { z.removeListener(b, d) } var e = a.call(this, b); if (0 > e.getListenerIndex(d)) { e = e.listeners;
                    h || (h = this);
                    isNaN(g) && (g = 10); var z = this;
                    l.fn = d;
                    l.priority = g; for (var w = e.length - 1; 0 <= w; w--)
                        if (e[w].priority <= g) return e.splice(w + 1, 0, l), { removeListener: v };
                    e.unshift(l) } return { removeListener: v } },
    ...
    CKEDITOR.dom = {};
    (function() {
        function a(a, w, b) { this._minInterval = a;
            this._context = b;
            this._lastOutput = this._scheduledTimer = 0;
            this._output = CKEDITOR.tools.bind(w, b || {}); var c = this;
            this.input = function() {
                function a() { c._lastOutput = (new Date).getTime();
                    c._scheduledTimer = 0;
                    c._call() } if (!c._scheduledTimer || !1 !== c._reschedule()) { var z = (new Date).getTime() - c._lastOutput;
        ...
        function d(z, b, c) {
            ...
            this.input = CKEDITOR.tools.override(this.input,
                function(a) { return function() { e._args = Array.prototype.slice.call(arguments);
                        a.call(this) } })
        }
        var b = [],
        ...
        CKEDITOR.tools = {
            ...
            extend: function(a) { var b = arguments.length,
                    c, e; "boolean" == typeof(c = arguments[b - 1]) ? b-- : "boolean" == typeof(c = arguments[b - 2]) && (e = arguments[b - 1], b -= 2); for (var g = 1; g < b; g++) { var m = arguments[g] || {};
                    CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(m), function(b) { if (!0 === c || null == a[b])
                            if (!e || b in e) a[b] = m[b] }) } return a },
            ...
            buildStyleHtml: function(a) { a = [].concat(a); for (var b, c = [], e = 0; e < a.length; e++)
            ...
            transformPlainTextToHtml: function(a, b) {
                ...
                if (!c) { var m = /\n{2}/g; if (m.test(e)) var d = "\x3c" + g + "\x3e",
                        l = "\x3c/" + g + "\x3e",
            ...
            override: function(a,
                b) { var c = b(a);
                c.prototype = a.prototype; return c },
            setTimeout: function(a, b, c, e, g) { g || (g = window);
                c || (c = g); return g.setTimeout(function() { e ? a.apply(c, [].concat(e)) : a.apply(c) }, b || 0) },
            ...
            indexOf: function(a, b) { if ("function" == typeof b)
                    for (var c = 0, e = a.length; c < e; c++) { if (b(a[c])) return c } else { if (a.indexOf) return a.indexOf(b);
                        c = 0; for (e = a.length; c < e; c++)
                            if (a[c] === b) return c }
                return -1 },
            ...
            createClass: function(a) {
                ...
                if (e) var m = b,
                    b = function() { var a = this._ || (this._ = {}),
                            b; for (b in e) { var c = e[b];
                            a[b] = "function" == typeof c ? CKEDITOR.tools.bind(c, this) : c }
                        m.apply(this, arguments) };
                c && (b.prototype = this.prototypedCopy(c.prototype), b.prototype.constructor = b, b.base = c, b.baseProto = c.prototype, b.prototype.base = function y() { this.base = c.prototype.base;
            ...
            cssLength: function() { var a = /^-?\d+\.?\d*px$/,
                    b; return function(c) { b = CKEDITOR.tools.trim(c + "") + "px"; return a.test(b) ? b : c || "" } }(),
            convertToPx: function() {
                ...
                return function(b) {
                    ...
                    if (!/%$/.test(b)) { var c = 0 > parseFloat(b);
                        c && (b = b.replace("-", ""));
                        a.setStyle("width", b);
                        b = a.$.clientWidth; return c ? -b : b }
                    return b
                }
            }(),
            ...
            normalizeCssText: function(a, b) { var c = [],
                    e, g = CKEDITOR.tools.parseCssText(a, !0, b); for (e in g) c.push(e + ":" + g[e]);
            ...
            _isValidColorFormat: function(a) { if (!a) return !1;
                a = a.replace(/\s+/g, ""); return /^[a-z0-9()#%,./]+$/i.test(a) },
            ...
            writeCssText: function(a, b) { var c, e = []; for (c in a) e.push(c + ":" + a[c]);
                b && e.sort(); return e.join("; ") },
            objectCompare: function(a, b, c) { var e; if (!a && !b) return !0; if (!a || !b) return !1; for (e in a)
                    if (a[e] != b[e]) return !1;
                if (!c)
                    for (e in b)
                        if (a[e] != b[e]) return !1;
            ...
            getStyledSpans: function(a, b) { var c = CKEDITOR.env.ie && 8 == CKEDITOR.env.version ? a.toUpperCase() : a,
                    c = b.find("span[style*\x3d" + c + "]").toArray(); return CKEDITOR.tools.array.filter(c, function(b) { return !!b.getStyle(a) }) },
            ...
            checkIfAnyArrayItemMatches: function(a, b) { for (var c = 0, e = a.length; c < e; ++c)
            ...
            keystrokeToString: function(a,
                b) { var c = this.keystrokeToArray(a, b);
                c.display = c.display.join("+");
                c.aria = c.aria.join("+"); return c },
            keystrokeToArray: function(a, b) { var c = b & 16711680,
                    e = b & 65535,
                    g = CKEDITOR.env.mac,
                    m = [],
                    d = [];
                ...
                e && (a[e] ? (m.push(a[e]), d.push(a[e])) : (m.push(String.fromCharCode(e)), d.push(String.fromCharCode(e)))); return { display: m, aria: d } },
            transparentImageData: "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw\x3d\x3d",
            getCookie: function(a) { a = a.toLowerCase(); for (var b = document.cookie.split(";"), c, e, g = 0; g < b.length; g++)
            ...
            normalizeMouseButton: function(a, b) { if (!CKEDITOR.env.ie || 9 <= CKEDITOR.env.version && !CKEDITOR.env.ie6Compat) return a; for (var c = [
            ...
            convertHexStringToBytes: function(a) { var b = [],
                    c = a.length / 2,
                    e; for (e = 0; e < c; e++) b.push(parseInt(a.substr(2 * e, 2), 16)); return b },
            convertBytesToBase64: function(a) {
                var b =
                    "",
                    c = a.length,
                    e;
                for (e = 0; e < c; e += 3) { var g = a.slice(e, e + 3),
                        m = g.length,
                        d = [],
                        l; if (3 > m)
                        for (l = m; 3 > l; l++) g[l] = 0;
                    ...
                    d[3] = g[2] & 63; for (l = 0; 4 > l; l++) b = l <= m ? b + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d[l]) : b + "\x3d" }
                return b
            },
            style: {
                parse: {
            ...
            array: {
                filter: function(a, b, c) { var e = [];
                    this.forEach(a, function(g, m) { b.call(c, g, m, a) && e.push(g) }); return e },
                find: function(a, b, c) { for (var e = a.length, g = 0; g < e;) { if (b.call(c, a[g], g, a)) return a[g];
                        g++ } },
                forEach: function(a, b, c) { var e = a.length,
                        g; for (g = 0; g < e; g++) b.call(c, a[g], g, a) },
                ...
                some: function(a, b, c) { for (var e = 0; e < a.length; e++)
            ...
            object: {
                ...
                keys: function(a) { var b = Object.prototype.hasOwnProperty,
                        c = [],
                        e = CKEDITOR.tools.object.DONT_ENUMS; if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (!a || "object" !== typeof a)) { b = []; if ("string" === typeof a)
                            for (c = 0; c < a.length; c++) b.push(String(c)); return b } for (var g in a) c.push(g); if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version)
                        for (g = 0; g < e.length; g++) b.call(a, e[g]) && c.push(e[g]); return c },
                ...
                merge: function(a, b) { var c = CKEDITOR.tools,
                        e = c.clone(a),
                        g = c.clone(b);
                    c.array.forEach(c.object.keys(g), function(a) { e[a] = "object" === typeof g[a] && "object" === typeof e[a] ? c.object.merge(e[a], g[a]) : g[a] }); return e }
            },
            getAbsoluteRectPosition: function(a, b) {
                function c(a) { if (a) { var b = a.getClientRect();
                        e.top += b.top;
                        e.left += b.left; "x" in e && "y" in e && (e.x += b.x, e.y += b.y);
        ...
        a.prototype = { reset: function() { this._lastOutput = 0;
                this._clearTimer() }, _reschedule: function() { return !1 }, _call: function() { this._output() }, _clearTimer: function() { this._scheduledTimer && clearTimeout(this._scheduledTimer);
        ...
        CKEDITOR.tools.style.border = CKEDITOR.tools.createClass({
            ...
            statics: {
                fromCssRule: function(a) { var b = {},
                        c = a.split(/\s+/g);
                    a = CKEDITOR.tools.style.parse._findColor(a);
                    a.length && (b.color = a[0]);
                    CKEDITOR.tools.array.forEach(c, function(a) { b.style || -1 === CKEDITOR.tools.indexOf(CKEDITOR.tools.style.parse._borderStyle, a) ? !b.width && CKEDITOR.tools.style.parse._widthRegExp.test(a) && (b.width = a) : b.style = a }); return new CKEDITOR.tools.style.border(b) },
                splitCssValues: function(a, b) {
                    b = b || {};
                    var c = CKEDITOR.tools.array.reduce(["width",
                        "style", "color"
                    ], function(c, e) { var g = a["border-" + e] || b[e];
                        c[e] = g ? CKEDITOR.tools.style.parse.sideShorthand(g) : null; return c }, {});
                    return CKEDITOR.tools.array.reduce(["top", "right", "bottom", "left"], function(b, e) { var g = {},
                            d; for (d in c) { var l = a["border-" + e + "-" + d];
                            g[d] = l ? l : c[d] && c[d][e] }
                        b["border-" + e] = new CKEDITOR.tools.style.border(g); return b }, {})
                }
            }
        });
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || h.scrollLeft, c = d.$.scrollTop || h.scrollTop) : (c = w ? d.$ : h, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - m, c = f.top + c - u) } else
                    for (u = this, m = null; u && "body" != u.getName() &&
                        "html" != u.getName();) { b += u.$.offsetLeft - u.$.scrollLeft;
                        c += u.$.offsetTop - u.$.scrollTop;
                        u.equals(this) || (b += u.$.clientLeft || 0, c += u.$.clientTop || 0); for (; m && !m.equals(u);) b -= m.$.scrollLeft, c -= m.$.scrollTop, m = m.getParent();
                        m = u;
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function u(a, b) { var c = { x: 0, y: 0 }; if (!a.is(k ? "body" : "html")) { var e = a.$.getBoundingClientRect();
                        c.x = e.left;
                        c.y = e.top }
                    e = a.getWindow();
                    e.equals(b) || (e = u(CKEDITOR.dom.element.get(e.$.frameElement), b), c.x += e.x, c.y += e.y); return c }
    ...
    (function() {
        ...
        function d(a, b, c, d, f) {
            function h(a, b, c, e) { var E = c ? a.getPrevious() : a.getNext(); if (e && k) return E;
                l || e ? b.append(a.clone(!0, f), c) : (a.remove(), v && b.append(a, c)); return E }

            function m() { var a, b, c, e = Math.min(S.length, t.length); for (a = 0; a < e; a++)
            ...
            if (l && C.type == CKEDITOR.NODE_TEXT && (n.equals(C) || n.type === CKEDITOR.NODE_ELEMENT && n.getFirst().equals(C))) c.append(a.document.createText(C.substring(L, B)));
                ...
                for (var S = n.getParents(), t = C.getParents(), P = m(),
                        I = S.length - 1, p = t.length - 1, J = c, E, ba, K, da = -1, U = P; U <= I; U++) { ba = S[U];
                    K = ba.getNext(); for (U != I || ba.equals(t[U]) && I < p ? b && (E = J.append(ba.clone(0, f))) : N ? h(ba, J, !1, D) : x && J.append(a.document.createText(ba.substring(L))); K;) { if (K.equals(t[U])) { da = U; break }
                        K = h(K, J) }
                    J = E }
                J = c;
                for (U = P; U <= p; U++)
                    if (c = t[U], K = c.getPrevious(), c.equals(S[U])) b && (J = J.getChild(0));
                    else { U != p || c.equals(S[U]) && p < I ? b && (E = J.append(c.clone(0, f))) : q ? h(c, J, !1, r) : T && J.append(a.document.createText(c.substring(0, B))); if (U > da)
                            for (; K;) K = h(K, J, !0);
                        J = E }
                l ||
                    g()
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        for (l = c(l); l || n;) {
                            if (l && !n) {!C && l.equals(m) && (C = !0); if (f ? l.isBlockBoundary() : !g.contains(l)) break;
                            ...
                            for (; n;)
                                if (B = !1, n.type == CKEDITOR.NODE_COMMENT) n = n.getPrevious();
                                    ...
                                    if (n) { B = n.getPrevious(); if (!l && !B) { l = n;
                                            n = null; break }
                                        n = B } else l = null
                                }
                            l && (l = c(l.getParent()))
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var x, T, S = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            t = null,
                            P = function(a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                    if (t) { if (t.equals(a)) { t = null; return } } else t = a;
                                else if (t) return; var b = S(a);
                                b || (x = a); return b },
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone();
                            l = new CKEDITOR.dom.walker(l); var I = CKEDITOR.dom.walker.whitespaces(),
                                p = CKEDITOR.dom.walker.bookmark();
                            l.evaluator = function(a) { return !I(a) && !p(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break }
                        l = this.clone();
                        l.collapse();
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                return function(b) { for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), m = d.block || d.blockLimit, f; m && !m.equals(d.root) && !m.getFirst(a(m));) f = m.getParent(), this[b ? "setEndAt" : "setStartAt"](m, CKEDITOR.POSITION_AFTER_END), m.remove(1), m = f;
            ...
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; m;) {
                    ...
                    if (G) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (G = 0);
                        ...
                        var n = m.getName();
                        if (CKEDITOR.dtd.$block[n] && "false" == m.getAttribute("contenteditable")) { d = m;
                            b(this, a, d); break } else if (m.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { if ("br" == n) G = 1;
                            else if (!k && !m.getChildCount() && "hr" != n) { d = m;
                                w = m.equals(u); break }
                    ...
                    w = (!M || G) && m.equals(u);
                    if (k && !M)
                        for (; !m.getNext(g) && !w;) { n = m.getParent(); if (n.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { M = 1;
                                G = 0;
                                w || n.equals(u);
                                k.setEndAt(n, CKEDITOR.POSITION_BEFORE_END); break }
                            m = n;
                            G = 1;
                            w = m.equals(u);
                            H = 1 }
    ...
    (function() {
        function a(a, b, c, d, f) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (q in S) { m = S[q];
                    t = p[m];
                    h = [];
                    g = void 0; for (g in t) - 1 < g.indexOf("*") ? h.push(new RegExp("^" + g.replace(/\*/g, ".*") + "$")) : h.push(g);
                    t = h;
                    t.length && (p[m] = t, r = !1) }
                p.nothingRequired = r;
        ...
        function c(a, b, c) { if (!a.match || a.match(b)) { if (a.noProperties) return !1;
                ...
                a = a.classes;
                b = b.classes; if (a) { for (var d = !1, e = !0 === a, n = b.length; n--;)
        ...
        function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = r(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {},
                d = 0,
        ...
        function e(a) { var b, c, d, f, e = {},
                n = 1; for (a = r(a); b = a.match(t);)(c = b[2]) ? (d = z(c, "styles"), f = z(c, "attrs"), c = z(c, "classes")) : d = f = c = null, e["$" + n++] = { elements: b[1], classes: c, styles: d, attributes: f }, a = a.slice(b[0].length); return e }
        ...
        function A(a, b, f, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) { a: { t = a.elementCallbacks; for (var r = 0, h = t.length, g; r < h; ++r)
                        if (g = t[r](b)) { t = g; break a }
                    t = void 0 } if (t) return t }
            if (e.doTransform && (t = a._.transformations[b.name])) { w(b); for (r = 0; r < t.length; ++r) n(a, b, t[r]);
                u(b) }
            if (e.doFilter) {
                a: {
                    ...
                    if (a || t) { w(b); if (r)
                        ...
                        if (h)
                            for (x = 0, D = h.length; x < D; ++x) c(h[x], b, k); if (a)
                            for (x = 0, D = a.length; x < D; ++x) d(a[x], b, k, g); if (t)
                ...
                if (!a.allStyles || a.hadInvalidStyle) { for (B in J) a.allStyles || P[B] ? l.push(B + ":" + J[B]) : x = !0;
                    l.length && (r.style = l.sort().join("; ")) } else C && (r.style = C);
                if (!a.allClasses ||
                    a.hadInvalidClass) { for (B = 0; B < h.length; ++B)(a.allClasses || t[h[B]]) && k.push(h[B]);
                    k.length && (r["class"] = k.sort().join(" "));
                    g && k.length < g.split(/\s+/).length && (x = !0) } else g && (r["class"] = g);x && (q = 1);
        ...
        CKEDITOR.filter.prototype = {
            ...
            getAllowedEnterMode: function() {
                ...
                return function(c, d) { var f = a.slice(),
                        e; if (this.check(x[c])) return c; for (d || (f = f.reverse()); e = f.pop();)
        ...
        J = CKEDITOR.filter.transformationsTools = {
            ...
            splitMarginShorthand: function(a) {
                ...
                if (a.styles.margin) { var c = a.styles.margin.match(/(auto|0|(?:\-?[\.\d]+(?:\w+|%)))/g) || ["0px"]; switch (c.length) {
                        case 1:
                            b([0, 0, 0, 0]); break;
                        case 2:
                            b([0, 1, 0, 1]); break;
            ...
            load: function(b, c, f, h) {
                ...
                if (0 === l) z(!0);
                    ...
                    var w = function(a, b) {
                        ...
                        A = function(b, c) { a[b] = 1; var f = d[b];
                        ...
                        F = function(b) {
                            if (a[b]) w(b, !0);
                                ...
                                if (!(1 < f.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function() { if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, A(b, !0) } : (e.$.onload = function() { setTimeout(function() { e.$.onload = null;
                                            e.$.onerror = null;
                                            A(b, !0) }, 0) }, e.$.onerror = function() { e.$.onload = null;
                                        e.$.onerror = null;
                                        A(b, !1) }));
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function(a, d, b) {
            ...
            for (var c = this.loaded, f = this.registered, h = [], k = {}, g = {}, l = 0; l < a.length; l++) { var v = a[l]; if (v)
                    if (c[v] || f[v]) g[v] = this.get(v);
                    else { var e = this.getFilePath(v);
                        h.push(e);
                        e in k || (k[e] = []);
                        k[e].push(v) } }
            CKEDITOR.scriptLoader.load(h,
                function(a, f) { if (f.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + k[f[0]].join(",") + '" was not found at "' + f[0] + '".'); for (var e = 0; e < a.length; e++)
                        for (var h = k[a[e]], l = 0; l < h.length; l++) { var m = h[l];
                            g[m] = this.get(m);
                            c[m] = 1 }
                    d.call(b, g) }, this)
        }
    ...
    (function() {
        ...
        function k(a) { var b = a.config.customConfig; if (!b) return !1; var b = CKEDITOR.getUrl(b),
                c = u[b] || (u[b] = {});
            c.fn ? (c.fn.call(a, a.config), CKEDITOR.getUrl(a.config.customConfig) != b && k(a) || a.fireOnce("customConfigLoaded")) : CKEDITOR.scriptLoader.queue(b, function() { c.fn = c.fn || CKEDITOR.editorConfig || function() {};
                k(a) }); return !0 }
        ...
        function v(a) { CKEDITOR.lang.load(a.config.language, a.config.defaultLanguage, function(b, c) { var d = a.config.title;
                a.langCode = b;
                    ...
                    CKEDITOR.scriptLoader.load(e, function() {
                        if (!a.isDestroyed() && !a.isDetached()) {
                            for (var b = ["beforeInit", "init", "afterInit"], e = 0; e < b.length; e++)
                                for (var n = 0; n < d.length; n++) { var r = d[n];
                                    0 === e && f[n] && r.lang && r.langEntries && (a.lang[r.name] = r.langEntries[f[n]]); if (r[b[e]]) r[b[e]](a) }
            ...
            parse: function(b) {
                for (var c, f, h = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (k) k.push(c[0]);
                                ...
                                l, v = c[4];
                            c = !!c[5]; if (v)
                                for (; l = a.exec(v);) { var e = l[1].toLowerCase();
                                    l = l[2] || l[3] || l[4] || "";
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(h, k, g) {
                ...
                function z(b, c, d) { c = c || y || u; var f = y;
                ...
                F.onText = function(a) { if (!(y._.hasInlineStarted && !M.length || H || G) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = y.name,
                        e = b ? CKEDITOR.dtd[b] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!G && !e["#"] && b in d) F.onTagOpen(f[b] || ""), F.onText(a);
                    else { v();
                        l();
                        H || G || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
            ...
            exec: function(a, c) {
                ...
                for (z = 0; z < g; z++)
                    if (d && (l = c.type, v = c.name), e = k[z], !(a.nonEditable && !e.options.applyToAll ||
                            a.nestedEditable && e.options.excludeNestedEditable)) { e = e.value.apply(null, h); if (!1 === e || d && e && (e.name != v || e.type != l)) return e;
                        null != e && (h[0] = c = e) }
                return c
            },
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            writeHtml: function(a, b) { b && this.filter(b); var h = this.name,
                ...
                l = 0; for (v = k.length; l < v; l++) g = k[l], a.attribute(g[0], g[1]);
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) { var g = d.checkDirty(),
                    ...
                    d._.previousModeData = l = d.getData(1); "source" == d.mode && k == l && (d.fire("lockSnapshot", { forceUpdate: !0 }), v = 1);
    ...
    (function() {
            ...
            proto: {
                ...
                extractHtmlFromRange: function(a, b) {
                    ...
                    if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"),
                                ...
                                d = !1 }
                            d = !d }
                        d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), A(a.startContainer) && a.startContainer.appendBogus();
                            ...
                            if (c in D && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                                ...
                                if (d.collapsed) a: {
                                    ...
                                    if (f && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(f, !c) && d.collapsed) {
                                        if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) { var t = d.startContainer.getChild(d.startOffset - (c ? 1 : 0)); if (t && t.type == CKEDITOR.NODE_ELEMENT && t.is("hr")) { a.fire("saveSnapshot");
                                                t.remove();
                                                b = !0; break a } }
                                        d = d.startPath().block;
        ...
        m = function() {
            ...
            return function(t, x, I, p) {
                ...
                if (!p.checkReadOnly()) {
                    ...
                    if (!E.collapsed) { u = y.block || y.blockLimit; var aa = E.getCommonAncestor();
                    ...
                    if (t = I) {
                        t = x.range;
                        if ("text" == x.type && x.inlineStylesRoot) { p = x.inlineStylesPeak;
                            J = p.getDocument().createText("{cke-peak}"); for (V = x.inlineStylesRoot.getParent(); !p.equals(V);) J = J.appendTo(p.clone()), p = p.getParent();
                            I = J.getOuterHtml().split("{cke-peak}").join(I) }
                        p = x.blockLimit.getName();
                        if (/^\s+|\s+$/.test(I) && "span" in CKEDITOR.dtd[p]) { var W = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            I = W + I + W }
                    ...
                    if (t) {
                        ...
                        for (h(J, Q); V < J.length; V++) {
                            ...
                            if (K) I = 0 < V;
                                ...
                                if ((K = Q.startPath().block) && !K.equals(G)) { if (R = K.getBogus()) R.remove(), W.push(K);
                                    G = K }
                                E.firstNotAllowed &&
                                    (z = 1);
                                if (z && E.isElement) { K = Q.startContainer; for (u = null; K && !r[K.getName()][E.name];) { if (K.equals(p)) { K = null; break }
                                        u = K;
                                        K = K.getParent() } if (K) u && (H = Q.splitElement(u), x.zombies.push(H), x.zombies.push(u));
                                    else { u = p.getName();
                                        M = !V;
                                        K = V == J.length - 1;
                                        u = d(E.node, u);
                                        A = [];
                                        y = u.length; for (var aa = 0, ca = void 0, Y = 0, X = -1; aa < y; aa++) ca = u[aa], " " == ca ? (Y || M && !aa || (A.push(new CKEDITOR.dom.text(" ")), X = A.length), Y = 1) : (A.push(ca), Y = 0);
                                        K && X == A.length && A.pop();
                                        M = A } }
                                if (M) { for (; K = M.pop();) Q.insertNode(K);
                                    M = 0 } else Q.insertNode(E.node);
        ...
        G = {
            ...
            bogus: { exclude: function(a) { var b = a.range.getBoundaryNodes(),
                        c = b.startNode,
                        b = b.endNode;!b || !F(b) || c && c.equals(b) || a.range.setEndBefore(b) } },
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({ tr: 1, table: 1 })) { var r = e.contains("table").getParent();
                        g = function(a) { return !a.equals(r) } } else if (e.block &&
                        e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !f.equals(c))) { var h = e.contains(CKEDITOR.dtd.$list).getParent();
            ...
            return {
                list: {
                    ...
                    merge: function(a, c) {
                        if (a.mergeListBookmark) {
                            ...
                            if (a.mergeList) { var h = f.contains(CKEDITOR.dtd.$list),
                ...
                table: function() {
                    ...
                    return {
                        ...
                        deleteRanges: function(a) { for (var b; b = a.tableContentsRanges.pop();) b.extractContents(), A(b.startContainer) && b.startContainer.appendBogus();
    ...
    (function() {
        ...
        function e(a) { z(a, !1); var b = a.getDocument().createText(y);
        ...
        function F(a) { var b = { 37: 1, 39: 1, 8: 1, 46: 1 }; return function(c) { var d = c.data.getKeystroke(); if (b[d]) { var e = a.getSelection().getRanges(),
                        f = e[0];
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                function a() { v = new CKEDITOR.dom.selection(c.getSelection());
                    v.lock() }
                ...
                var f = c.document,
                    ...
                    D = p.isInline(),
                    n, v;
                CKEDITOR.env.gecko && p.attachListener(p, "focus", function(a) { a.removeListener();
                    0 !== n && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == p.$ && (a = c.createRange(), a.moveToElementEditStart(p), a.select()) }, null, null, -2);
                ...
                if (CKEDITOR.env.ie || CKEDITOR.env.gecko || D) m ? p.attachListener(p, "beforedeactivate", a, null, null, -1) : p.attachListener(c, "selectionCheck", a, null, null, -1), p.attachListener(p, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur", function() { var a = v && (v.isFake || 2 > v.getRanges().length);
                        CKEDITOR.env.gecko && !D && a || (c.lockSelection(v), n = 1) }, null, null, -1),
                    p.attachListener(p, "mousedown", function() { n = 0 });
                if (CKEDITOR.env.ie && !D) {
                    ...
                    p.attachListener(p, "mouseup", function(a) { 2 == a.data.$.button && u && (c.document.$.documentElement.scrollLeft = u.x, c.document.$.documentElement.scrollTop = u.y);
                        u = null });
                    if ("BackCompat" != f.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            var w, A;
                            q.on("mousedown", function(a) {
                                function b(a) { a = a.data.$; if (w) { var c = l.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) {}
                ...
                if (D && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) { var y;
                    ...
                    p.attachListener(f.getDocumentElement(), "mouseup", function() { y && k.call(c);
                        y = 0 }) } else p.attachListener(CKEDITOR.env.ie ? p : f.getDocumentElement(), "mouseup", k, c);
                CKEDITOR.env.webkit && p.attachListener(f, "keydown", function(a) { switch (a.data.getKey()) {
                        case 13:
                        case 33:
                        case 34:
                        case 35:
            ...
            getRanges: function() {
                var a = m ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        if (-1 == m || m == e.length - 1 && 0 > q) { h.moveToElementText(d);
                            h.setEndPoint("StartToStart", b);
                            h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                            e = d.childNodes; if (!h) return f = e[e.length - 1], f.nodeType != CKEDITOR.NODE_TEXT ? { container: d, offset: e.length } : { container: f, offset: f.nodeValue.length }; for (d = e.length; 0 < h && 0 < d;) g = e[--d], g.nodeType == CKEDITOR.NODE_TEXT && (r = g, h -= g.nodeValue.length); return { container: r, offset: -h } }
                        h.collapse(0 < q ? !0 : !1);
                ...
                return function(b) { var c = this._.cache,
                        d = c.ranges;
                    d || (c.ranges = d = new CKEDITOR.dom.rangeList(a.call(this))); return b ? u(new CKEDITOR.dom.rangeList(d.slice())) : d }
            }(),
                        ...
                        if (t) this.fake(t);
                            ...
                            if (m) {
                                ...
                                for (E = 0; E < a.length; E++) {
                                    if (E < a.length - 1 && (p = a[E], n = a[E + 1], t = p.clone(), t.setStart(p.endContainer, p.endOffset), t.setEnd(n.startContainer, n.startOffset), !t.collapsed && (t.shrink(CKEDITOR.NODE_ELEMENT, !0), b = t.getCommonAncestor(), t = t.getEnclosedNode(), b.isReadOnly() || t && t.isReadOnly()))) { n.setStart(p.startContainer, p.startOffset);
                                    ...
                                    try { n.setEnd(b.endContainer.$, b.endOffset) } catch (w) { if (0 <= w.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), n.setEnd(b.endContainer.$, b.endOffset);
                                        else throw w; }
                                    k.addRange(n)
                                }
                            }
    ...
    (function() {
                ...
                for (q.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
                    ...
                    if (q.equals(w)) q = null, l = !0;
                        ...
                        if (x && m && CKEDITOR.dtd.$block[A])
                            for (var B = q, C = f(B), D = void 0, G = C.length, H = 0, B = G && new CKEDITOR.dom.range(B.getDocument()); H < G; ++H) { var D = C[H],
                                    L = CKEDITOR.filter.instances[D.data("cke-filter")]; if (L ? L.check(this) : 1) B.selectNodeContents(D), b.call(this, B) }
                        C = A ? !n[A] || y ? 0 : x && !m ? 0 : d(q, w, h, T) : 1;
                        if (C)
                            if (D =
                                q.getParent(), C = h, G = g, H = k, !D || !(D.getDtd() || CKEDITOR.dtd.span)[G] && !H || C.parentRule && !C.parentRule(D)) l = !0;
                            else { if (z || A && CKEDITOR.dtd.$removeEmpty[A] && (q.getPosition(w) | T) != T || (z = c.clone(), z.setStartBefore(q)), A = q.type, A == CKEDITOR.NODE_TEXT || x || A == CKEDITOR.NODE_ELEMENT && !q.getChildCount()) { for (var A = q, N;
                    ...
                    if (l && z && !z.collapsed) {
                        for (var l = M(this, e), x = l.hasAttributes(), y = z.getCommonAncestor(),
                                A = {}, C = {}, D = {}, G = {}, Y, X, Z; l && y;) { if (y.getName() == g) { for (Y in h.attributes) !G[Y] && (Z = y.getAttribute(X)) && (l.getAttribute(Y) == Z ? C[Y] = 1 : G[Y] = 1); for (X in h.styles) !D[X] && (Z = y.getStyle(X)) && (l.getStyle(X) == Z ? A[X] = 1 : D[X] = 1) }
                            y = y.getParent() }
        ...
        function c(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(m.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) { var h = a.elements[g]; if (h == a.block || h == a.blockLimit) break;
            ...
            if (a.collapsed) {
                ...
                if (g) { e = d; for (h = 0;; h++) { k = f.elements[h]; if (k.equals(g)) break;
        ...
        function g(a) { var b = a.createBookmark(!0),
            ...
            this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = M(this, e, d), v(d, f));
            a.moveToBookmark(b) }
        ...
        function F(a) { for (var b = H(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || A.call(this, d, !0); for (var f in b)
                if (f != this.element)
                    for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e), d.isReadOnly() || u(d, b[f]) }

        function u(a,
            b, c) { if (b = b && b.attributes)
                for (var d = 0; d < b.length; d++) { var e = b[d][0],
                        f; if (f = a.getAttribute(e)) { var g = b[d][1];
                        (null === g || g.test && g.test(f) || "string" == typeof g && f == g) && a.removeAttribute(e) } }
            c || m(a) }

        function m(a, b) {
            if (!a.hasAttributes() || b)
                if (CKEDITOR.dtd.$block[a.getName()]) { var c = a.getPrevious(x),
                        d = a.getNext(x);!c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({ br: 1 }) || a.append("br", 1);!d || d.type != CKEDITOR.NODE_TEXT && d.isBlockBoundary({ br: 1 }) || a.append("br");
        ...
        function n(a, b, c) { var d = new CKEDITOR.dom.element("span");
        ...
        function L(a, b, c) { var d = a.getRanges();
            b = b ? this.removeFromRange : this.applyToRange; for (var e, f = d.createIterator(); e = f.getNextRange();) b.call(this, e, c);
            a.selectRanges(d) }
        ...
        CKEDITOR.dom.elementPath = function(b, f) {
            ...
            do
                if (l.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (l.equals(f)) break;
                    if (!k && (v = l.getName(),
                            "true" == l.getAttribute("contenteditable") ? k = l : !h && d[v] && (h = l), a[v])) { if (v = !h && "div" == v) { a: { v = l.getChildren(); for (var e = 0, z = v.count(); e < z; e++) { var w = v.getItem(e); if (w.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[w.getName()]) { v = !0; break a } }
                                v = !1 }
                            v = !v }
                        v ? h = l : k = l }
                }
    ...
    */
    ...
    (function() {
        function I(a) { a._.tabBarMode = !0;
            a._.tabs[a._.currentTabId][0].focus();
            a._.currentFocusIndex = -1 }

        function J() { for (var a = this._.tabIdList.length, b = CKEDITOR.tools.indexOf(this._.tabIdList, this._.currentTabId) + a, c = b - 1; c > b - a; c--)
        ...
        function Y() { var a = this.getInputElement();
        ...
        function ca(a) {
            ...
            a.parts.title.on("mousedown", function(g) {
                if (!a._.moved) { var f = a._.element;
        ...
        function R(a) { var b = a.data.$.ctrlKey || a.data.$.metaKey,
                c = a.data.$.altKey,
                e = a.data.$.shiftKey,
        ...
        function ea(a) { for (var b in x) { for (var c = x[b], e = c.length - 1; 0 <= e; e--) c[e].dialog != a && c[e].uiElement != a || c.splice(e, 1);
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            this.on("hide", function() { z.removeListener("keydown", d);
        ...
        CKEDITOR.dialog.prototype = {
            ...
            layout: function() {
                var a =
                    this.parts.dialog;
                if (this._.moved || !D) { var b = this.getSize(),
        ...
        var E = function(a, b, c) { for (var e = 0, d; d = a[e]; e++)
                    if (d.id == b || c && d[c] && (d = E(d[c], b, c))) return d;
                return null },
            F = function(a, b, c, e, d) { if (c) { for (var f = 0, g; g = a[f]; f++) { if (g.id == c) return a.splice(f, 0, b), b; if (e && g[e] && (g = F(g[e], b, c, e, !0))) return g } if (d) return null }
                a.push(b); return b },
            G = function(a, b, c) {
        ...
        (function() {
            ...
            CKEDITOR.on("instanceDestroyed", function(a) { if (CKEDITOR.tools.isEmpty(CKEDITOR.instances)) { for (var b; b = CKEDITOR.dialog._.currentTop;) b.hide(); for (var c in B) B[c].remove();
                    B = {} }
        ...
        CKEDITOR.plugins.add("dialog", { requires: "dialogui", init: function(a) { V || (CKEDITOR.document.appendStyleSheet(this.path + "styles/dialog.css"), V = !0);
